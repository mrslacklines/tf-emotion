...
from models import generate_vgg16, transfer_learn_face_network
...
#from trueface.resnet import ResnetBuilder
...
reduce_lr = ReduceLROnPlateau('val_loss', factor=0.00002,
